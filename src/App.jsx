...
const App = () => { 
   ...
   const loadTrendingMovies = async () =>{
    try{
      ...
      console.error('Error fetching trending movies :${error}', error);
      // setErrorMessage('Error fetching trending movies.') /*give amiguity issue so commit*/
    }
   }
  ...
  return (
    <main>
      ...
      <div className='wrapper'>
       <header>
        <img style={{width:'100px',height:'auto'}} src="logo.png" alt="" />
        <img src='./hero.png'  alt='Hero Banner' />
        <h1>Find <span className='text-gradient'>Movies</span> You'll Enjoy The Hustle</h1>
